...
public class Button extends Widget<Button> implements HasText<Button>, HasIcon<Button>, HasState<Button>, HasClickHandlers<Button>, HasMouseHandlers<Button>, HasFocusHandlers<Button>, HasKeyHandlers<Button> {
  ...
  @Override
  public Button onActivate(EventHandler<Void> handler) {
    return this.addHandler(HasActivation.FireableEvent.ACTIVATE, handler);
  }
  
  @Override
  public Button onDeactivate(EventHandler<Void> handler) {
  ...
  public Button deactivate() {
    this.fireEvent(HasActivation.FireableEvent.DEACTIVATE);
  ...
  public Button activate() {
    this.fireEvent(HasActivation.FireableEvent.ACTIVATE);
