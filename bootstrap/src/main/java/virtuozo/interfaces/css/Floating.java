...
public class Floating extends CssClass {
  ...
  public static final Floating LEFT = new Floating("pull-left");
  
  public static final Floating RIGHT = new Floating("pull-right");
