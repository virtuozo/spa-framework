...
public class Navbar extends Component<Navbar> {
  ...
  public class Facet extends Component<Facet> {
    ...
    public class NavItem extends Component<NavItem> implements HasText<NavItem>, HasClickHandlers<NavItem>, HasActivation<NavItem>, HasIcon<NavItem>, HasMouseHandlers<NavItem> {
      ...
      @Override
      public NavItem onMouseDown(MouseDownHandler handler) {
        this.anchor.on(handler);
        return this;
      }

      @Override
      public NavItem onMouseMove(MouseMoveHandler handler) {
        this.anchor.on(handler);
        return this;
      }

      @Override
      public NavItem onMouseOut(MouseOutHandler handler) {
        this.anchor.on(handler);
        return this;
      }

      @Override
      public NavItem onMouseOver(MouseOverHandler handler) {
        this.anchor.on(handler);
        return this;
      }

      @Override
      public NavItem onMouseUp(MouseUpHandler handler) {
        this.anchor.on(handler);
        return this;
      }

      @Override
      public NavItem onMouseWheel(MouseWheelHandler handler) {
        this.anchor.on(handler);
        return this;
      }
