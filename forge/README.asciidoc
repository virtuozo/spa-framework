== virtuozo-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The virtuozo-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.virtuozo.addon</groupId>
   <artifactId>virtuozo-addon</artifactId>
